class EnemyFlying extends Phaser.Physics.Arcade.Sprite {
    ...
    preUpdate(time, delta) {
        ...
        if (this.pathIndex > 1) this.remove(); // remove unit and free resources by killing it at the end of its path (which is intentionally off-screen to hide the death animation)
